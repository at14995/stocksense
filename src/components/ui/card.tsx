...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-[#121521]/95 border border-white/10 rounded-2xl p-6 md:p-8 shadow-xl shadow-black/30 hover:-translate-y-1 hover:shadow-2xl hover:shadow-indigo-900/40 transition-all duration-300",
      className
    )}
    {...props}
  />
